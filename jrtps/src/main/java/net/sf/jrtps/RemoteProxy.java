 ...
 * advertised both an unicast locator and a multicast locator. This class
 * allows to set which one will be used.
 * 
 * @author mcr70
...
public class RemoteProxy {
	 ...
	 * @param ucLocator Unicast locator
	 * @param mcLocator Multicast locator
	 */
	...
	/**
	 * Gets the Locator for the remote entity. Tries to return preferred locator (unicast or multicast).
	 * If the preferred locator is null, return non preferred locator. By default, unicast
	 * is preferred.
	 * 
	 * @return Locator
	 */
	...
	/**
	 * Sets whether or not to prefer multicast. Default is not to prefer multicast.
