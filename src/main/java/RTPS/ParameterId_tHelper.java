...
/**
* RTPS/ParameterId_tHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from rtps.idl
* 8. helmikuuta 2012 9.16.40 EET
*/

abstract public class ParameterId_tHelper
{
  private static String  _id = "IDL:RTPS/ParameterId_t:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (RTPS.ParameterId_tHelper.id (), "ParameterId_t", __typeCode);
    }
    return __typeCode;
  }
