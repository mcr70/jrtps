...
public class VendorId_t {
	...
	public String toString() {
		...
		if (bytes[0] == 1) {
			...
			switch(bytes[1]) {
			case 1: sb.append("Real-Time Innovations, Inc. (RTI)"); break;
			case 2: sb.append("PrismTech"); break;
			case 3: sb.append("Object Computing Incorporated, Inc. (OCI)"); break;
			case 4: sb.append("MilSoft"); break;
			case 5: sb.append("Kongsberg"); break;
			case 6: sb.append("TwinOaks Computing, Inc."); break;
			case 7: sb.append("Lakota Technical Solutions, Inc."); break;
			case 8: sb.append("ICOUP Consulting"); break;
			case 9: sb.append("ETRI Electronics and Telecommunication Research Institute"); break;
			}
			sb.append(')');
		}
