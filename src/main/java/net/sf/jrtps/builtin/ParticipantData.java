...
public class ParticipantData extends DiscoveredData {
	...
	public ParticipantData(GuidPrefix prefix, int endpoints, List<Locator> discoveryLocators,
		...
		this(prefix, endpoints, discoveryLocators, userdataLocators, null, null, participantQos);
	}
	
	public ParticipantData(GuidPrefix prefix, int endpoints, 
			List<Locator> discoveryLocators, List<Locator> userdataLocators, 
			IdentityToken iToken, PermissionsToken pToken,
		...
		this.userdataLocators = userdataLocators != null ? userdataLocators : new LinkedList<Locator>();
